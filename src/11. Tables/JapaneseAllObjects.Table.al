table 99101 "Japanese All Objects"
{
    Caption = 'Japanese All Objects';
    DrillDownPageId = "Japanese All Objects List";
    LookupPageId = "Japanese All Objects List";
    ...
    var
        JapaneseAllObjects: Record "Japanese All Objects";
    begin
        JapaneseAllObjects.Reset();
        JapaneseAllObjects.SetCurrentKey("Entry No.");
        if JapaneseAllObjects.FindLast() then
            "Entry No." := JapaneseAllObjects."Entry No." + 1
        else
            "Entry No." := 1;
    end;
